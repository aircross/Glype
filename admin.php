<?php
/*******************************************************************
* Glype is copyright and trademark 2007-2011 UpsideOut, Inc. d/b/a Glype
...
OUT;
		...
		<div id="footer">
			...
			<div id="footer_bg">
				<p><a href="http://www.glype.com/">Glype</a>&trade; &copy; 2007-2011 Glype. All rights reserved.</p>
			</div>
...
if ( $user->isAdmin() ) {
	...
	$output->addNavigation('Glype&trade; Licenses', 'https://www.glype.com/purchase.php');
	$output->addNavigation('BlockScript&trade;', $self.'?blockscript');
...
OUT;
	...
	******************************************************************/
	case 'blockscript':
		...
		$installed		 = $BS_VAL['license_agreement_accepted'] ? '<span class="ok-color">installed</span>' : '<span class="error-color">not installed</span>';
		$enabled		 = ($BS_VAL['license_agreement_accepted'] && !empty($CONFIG['enable_blockscript'])) ? '<span class="ok-color">enabled</span>' : '<span class="error-color">disabled</span>';
		...
		# Print header
		$output->title		 = 'BlockScript&trade;';
		$output->bodyTitle = 'BlockScript&trade; Integration';
...
OUT;
		if ($bsc) {
			echo '<div class="hr"></div><h2>Your BlockScript Installation</h2><p><a href="/blockscript/detector.php?blockscript=setup&bsap='.$BS_VAL['admin_password'].'" target="_blank">Login To Your BlockScript Control Panel</a></p>';
		}
		break;
